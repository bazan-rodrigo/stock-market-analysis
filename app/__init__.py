...
<body>
  <div class="container">
    ...
    _PAGES = [
        ...
        "app.pages.admin_packs",
        "app.pages.admin_calibration",
    ...
    _CALLBACKS = [
        ...
        "app.callbacks.pnf_config_callbacks",
