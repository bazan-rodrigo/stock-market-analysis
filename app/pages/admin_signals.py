            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dbc.Input(id="sig-f-indicator-key",
                              ...
                              style={"fontSize": "0.85rem"}),
                    html.Details([
                        html.Summary("Ver claves disponibles",
                                     style={"fontSize": "0.72rem", "color": "#6b7280",
                                            "cursor": "pointer", "marginTop": "4px"}),
                        html.Div([
                            html.Div("Régimen:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("regime_d  regime_w  regime_m",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                            html.Div("Volatilidad:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("vol_d  vol_w  vol_m",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                            html.Div("RSI:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("rsi  rsi_w  rsi_m",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                            html.Div("Distancia a SMA:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("vs_sma20  vs_sma50  vs_sma200  dist_sma_d  dist_sma_w  dist_sma_m",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                            html.Div("Drawdown:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("dd_current  dd_max1  dd_max2  dd_max3",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                            html.Div("ATR percentil:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("atr_pct_d  atr_pct_w  atr_pct_m",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                            html.Div("Variaciones %:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("var_daily  var_month  var_quarter  var_year  var_52w",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                            html.Div("Soporte/Resistencia:", style={"color": "#9ca3af", "marginTop": "4px"}),
                            html.Code("pivot_resist_pct  pivot_support_pct",
                                      style={"fontSize": "0.72rem", "color": "#94a3b8"}),
                        ], style={"backgroundColor": "#111827", "padding": "6px 8px",
