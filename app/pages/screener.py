...
_COLUMNS = [
    ...
    {"name": "SR Res%",      "id": "pivot_resist_pct",  "type": "numeric", "format": {"specifier": ".1f"}},
    {"name": "SR Sop%",      "id": "pivot_support_pct", "type": "numeric", "format": {"specifier": ".1f"}},
    {"name": "VP Res%",      "id": "vpvr_resist_pct",   "type": "numeric", "format": {"specifier": ".1f"}},
    {"name": "VP Sop%",      "id": "vpvr_support_pct",  "type": "numeric", "format": {"specifier": ".1f"}},
    ...
    return html.Div([
        ...
        dash_table.DataTable(
            ...
            tooltip_header={
                ...
                "pivot_resist_pct": {"value": "Distancia % al nivel de resistencia pivot más cercano (extremo local). Positivo = techo está X% por encima del precio actual.", "type": "text"},
                "pivot_support_pct": {"value": "Distancia % al nivel de soporte pivot más cercano (extremo local). Negativo = piso está X% por debajo del precio actual.", "type": "text"},
                "vpvr_resist_pct": {"value": "Distancia % al nodo de alto volumen (HVN) más cercano por encima del precio. Zonas de alta actividad histórica actúan como resistencia.", "type": "text"},
                "vpvr_support_pct": {"value": "Distancia % al nodo de alto volumen (HVN) más cercano por debajo del precio. Zonas de alta actividad histórica actúan como soporte.", "type": "text"},
            },
