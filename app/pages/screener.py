    ...
    return html.Div([
        ...
        dash_table.DataTable(
            ...
            tooltip_header={
                ...
                "pivot_resist_pct": {"value": "Distancia % al nivel S/R de resistencia más cercano (extremo local de precio). Positivo = techo está X% por encima del precio actual.", "type": "text"},
                "pivot_support_pct": {"value": "Distancia % al nivel S/R de soporte más cercano (extremo local de precio). Negativo = piso está X% por debajo del precio actual.", "type": "text"},
            },
